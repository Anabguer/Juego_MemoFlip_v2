...
echo ========================================
echo   SUBIR SOLO ARCHIVOS MODIFICADOS
echo   Solo index.html y nuevo JS/CSS
echo ========================================
echo.
...
"%WINSCP%" /ini=nul /log:"upload_archivos_modificados.log" /command ^
...
if "%ERRORLEVEL%"=="0" (
  ...
  echo Revisa log: upload_archivos_modificados.log
)
